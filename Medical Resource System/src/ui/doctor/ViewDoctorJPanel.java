...
public class ViewDoctorJPanel extends javax.swing.JPanel {
     ...
     */
    JPanel workArea;
    private DoctorDirectory doctoryDiretory;
    private Doctor doctor;
    
    public ViewDoctorJPanel(JPanel workArea, DoctorDirectory dd, Doctor d) {
        initComponents();
        this.workArea = workArea;
        this.doctoryDiretory = dd;
        this.doctor = d;
        populateForm();
    }
...
//        doctor.setId(Long.parseLong(txtId.getText()));
        doctor.setName(txtName.getText());
        doctor.setGender(txtGender.getText());
        doctor.setAge(Integer.parseInt(txtAge.getText()));
        doctor.setCity(txtCity.getText());
        doctor.setUsername(txtUsername.getText());
        doctor.setPassword(txtPassword.getText());
//        doctoryDiretory.addDoctor(doctor);
        JOptionPane.showMessageDialog(this, "Doctor successfully Updated", "Warning", JOptionPane.INFORMATION_MESSAGE);
    ...
    void back(){
        ...
        DoctorListJPanel doctorListJPanel = (DoctorListJPanel) component; 
        doctorListJPanel.refreshTable(doctoryDiretory);
